...
import com.cafs.shop.mapper.CartMapper;
import com.cafs.shop.mapper.ExpressMapper;
import com.cafs.shop.mapper.OrderDetailMapper;
...
public class OrderServiceImpl extends ServiceImpl<ShopOrderMapper, ShopOrder> implements OrderService {
    ...
    public PageInfo<ShopOrder> page(int draw, int start, int length, ShopOrder order) {
        ...
        int count = Math.toIntExact(shopOrderMapper.selectCount(Wrappers.lambdaQuery(order)));
